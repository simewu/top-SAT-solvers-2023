...
#define STATISTICS                                                              \
    ...
    COUNTER(ticks, 2, PER_PROPAGATION, 0, "per prop")                           \
...
struct statistics {
#define COUNTER(NAME, VERBOSE, OTHER, UNITS, TYPE) uint64_t NAME;
#define IGNORE(...)
...
#define COUNTER(NAME, VERBOSE, OTHER, UNITS, TYPE)                           \
    ...
    {                                                                        \
        ...
        statistics->NAME--;                                                  \
                                                                             ...
                                                                             \
    static inline void kissat_add_##NAME(statistics *statistics, uint64_t n) \
    {                                                                        \
        assert(UINT64_MAX - n >= statistics->NAME);                          \
        statistics->NAME += n;                                               \
    }                                                                        \
                                                                             \
    static inline void kissat_sub_##NAME(statistics *statistics, uint64_t n) \
    {                                                                        \
