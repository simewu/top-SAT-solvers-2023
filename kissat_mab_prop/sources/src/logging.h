...
void kissat_log_unsigneds(kissat *, size_t, const unsigned *, const char *, ...);

void kissat_log_extensions(kissat *, size_t, const extension *, const char *, ...);

void kissat_log_xor(struct kissat *, unsigned lit, unsigned size, unsigned *lits, const char *fmt, ...);
...
#define LOGTMP(...) LOGLITS(SIZE_STACK(solver->clause.lits), BEGIN_STACK(solver->clause.lits), __VA_ARGS__)
