...
#define all_literals_in_clause(LIT, C)                                  \
    unsigned LIT, *LIT##_PTR = BEGIN_LITS(C), *LIT##_END = END_LITS(C); \
...
void kissat_new_binary_clause(struct kissat *, bool redundant, unsigned, unsigned);
...
void kissat_delete_binary(struct kissat *, bool redundant, bool hyper, unsigned, unsigned);
