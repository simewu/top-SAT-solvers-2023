...
static void init_clause(kissat *solver, clause *res, bool redundant, unsigned glue, unsigned size)
{
...
static reference new_binary_clause(kissat *solver, bool original, bool redundant, unsigned first, unsigned second)
{
    assert(first != second);
...
static reference new_large_clause(kissat *solver, bool original, bool redundant, unsigned glue, unsigned size,
    unsigned *lits)
{
    assert(size > 2);
...
static reference new_clause(kissat *solver, bool original, bool redundant, unsigned glue, unsigned size, unsigned *lits)
{
    reference res;
    if (size == 2)
...
void kissat_new_binary_clause(kissat *solver, bool redundant, unsigned first, unsigned second)
{
...
void kissat_delete_binary(kissat *solver, bool redundant, bool hyper, unsigned a, unsigned b)
{
